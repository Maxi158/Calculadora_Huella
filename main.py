...
def main():
    ...
    while True:#Da inicio al menu de manera indeterminada hasta que el usuario elija salir
        ...
        if opc_prin == "1":
            ...
            while True:#iniciamos un while tru para cada pregunta para asegurarnos de que la respuesta este dentro de las opciones
            ...
            while True:
                ...
                if cons_alt in ["1", "2", "3"]:
                    break
                else:
                    print("\nOpción no válida. Por favor, selecciona 1, 2 o 3.")

            res_elec = fac_elec(tam_hog, cons_dia, cons_alt)
            ...
            while True:
                ...
                if trans_pri in ["1", "2", "3"]:
                    break
                else:
                    print("\nOpción no válida. Por favor, selecciona 1, 2 o 3.")

            res_gas = fac_gas(frec_uso, trans_pri)
            ...
            res_res = fac_res(cant_res, hab_res)
            ...
            res_diet = fac_diet(tip_diet, can_dia)
            ...
            res_dig = fac_dig (alm_ges,cons_stre,cons_dia,cons_stre)
